...
public class PictureEditor_ViewBinding implements Unbinder {
  private PictureEditor target;
  ...
  @UiThread
  public PictureEditor_ViewBinding(PictureEditor target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public PictureEditor_ViewBinding(final PictureEditor target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PictureEditor target = this.target;

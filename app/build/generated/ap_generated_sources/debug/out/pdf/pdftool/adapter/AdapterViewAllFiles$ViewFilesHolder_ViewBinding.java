...
public class AdapterViewAllFiles$ViewFilesHolder_ViewBinding implements Unbinder {
  private AdapterViewAllFiles.ViewFilesHolder target;

  @UiThread
  public AdapterViewAllFiles$ViewFilesHolder_ViewBinding(AdapterViewAllFiles.ViewFilesHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AdapterViewAllFiles.ViewFilesHolder target = this.target;

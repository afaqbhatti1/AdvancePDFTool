...
public class FragmentInvertPdf_ViewBinding implements Unbinder {
  private FragmentInvertPdf target;
  ...
  @UiThread
  public FragmentInvertPdf_ViewBinding(final FragmentInvertPdf target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FragmentInvertPdf target = this.target;

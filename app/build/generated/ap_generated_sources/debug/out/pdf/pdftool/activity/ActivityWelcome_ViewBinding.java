...
public class ActivityWelcome_ViewBinding implements Unbinder {
  ...
  @UiThread
  public ActivityWelcome_ViewBinding(ActivityWelcome target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ActivityWelcome_ViewBinding(final ActivityWelcome target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ActivityWelcome target = this.target;

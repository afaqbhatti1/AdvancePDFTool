...
public class AdapterRearrangePdf$ViewHolder_ViewBinding implements Unbinder {
  private AdapterRearrangePdf.ViewHolder target;

  @UiThread
  public AdapterRearrangePdf$ViewHolder_ViewBinding(AdapterRearrangePdf.ViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AdapterRearrangePdf.ViewHolder target = this.target;

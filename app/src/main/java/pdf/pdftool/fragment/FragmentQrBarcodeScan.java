...
import pdf.pdftool.util.TextToPDFUtils;
...
public class FragmentQrBarcodeScan extends Fragment implements View.OnClickListener, OnPDFCreatedInterface {
    ...
    OurCardView scanQrcode;
    @BindView(R.id.scan_barcode)
    OurCardView scanBarcode;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootview = inflater.inflate(R.layout.fragment_barcode_qrcode, container, false);
    ...
    private void createPdf(String mFilename, Uri uri) {
        ...
        try {
            ...
            fileUtil.createPdfFromTextFile(new OptionsTextToPDF(mFilename, PageSizeUtils.mPageSize, false,
    ...
    private void resetValues() {
        PictureToPDFOptions imageToPDFOptions = new PictureToPDFOptions();

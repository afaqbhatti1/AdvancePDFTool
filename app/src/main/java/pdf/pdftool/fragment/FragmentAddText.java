...
import pdf.pdftool.util.AOptionsAddTextEnhancementUtils;
...
import static pdf.pdftool.util.Constants.pdfExtension;

public class FragmentAddText extends Fragment implements AdapterMergeFiles.OnClickListener,
    ...
    private ArrayList<OptionsEntityEnhancement> mTextEnhancementOptionsEntityArrayList;
    private AdapterEnhancementOptions mTextEnhancementOptionsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.add_text_fragment, container, false);
    ...
    private void showEnhancementOptions() {
        ...
        mTextEnhancementOptionsEntityArrayList = AOptionsAddTextEnhancementUtils.getInstance()
                .getEnhancementOptions(mActivity, mFontTitle, mFontFamily);
        mTextEnhancementOptionsAdapter = new AdapterEnhancementOptions(this, mTextEnhancementOptionsEntityArrayList);

...
import pdf.pdftool.interfaces.OnTextToPdfInterface;
...
import pdf.pdftool.util.TextToPdfAsync;

import static android.app.Activity.RESULT_OK;
import static pdf.pdftool.util.Constants.READ_WRITE_PERMISSIONS;

public class FragmentTextToPdf extends Fragment implements OnItemClickListener,
    ...
    private OptionsTextToPDF.Builder mBuilder;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mBuilder = new OptionsTextToPDF.Builder(getContext());
        addEnhancements();
    ...
    private void showEnhancementOptions() {
        ...
        List<OptionsEntityEnhancement> optionsEntityist = new ArrayList<>();
        for (Enhancer enhancer: mEnhancerList) {
            optionsEntityist.add(enhancer.getEnhancementOptionsEntity());
        }
        mTextEnhancementOptionsAdapter = new AdapterEnhancementOptions(this, optionsEntityist);
    ...
    private void createPdf(String mFilename) {
        ...
        OptionsTextToPDF options = mBuilder.setFileName(mFilename)
        ...
        new TextToPdfAsync(fileUtil, options, mFileExtension,
                FragmentTextToPdf.this).execute();
    }

...
import pdf.pdftool.activity.ActivityFavourites;
import pdf.pdftool.activity.MainActivity;
...
import static pdf.pdftool.util.Constants.ADD_IMAGES_KEY;
import static pdf.pdftool.util.Constants.ADD_PASSWORD_KEY;
import static pdf.pdftool.util.Constants.ADD_PWD;
import static pdf.pdftool.util.Constants.ADD_TEXT_KEY;
...
import static pdf.pdftool.util.Constants.COMPRESS_PDF_KEY;
import static pdf.pdftool.util.Constants.EXCEL_TO_PDF_KEY;
import static pdf.pdftool.util.Constants.EXTRACT_IMAGES;
import static pdf.pdftool.util.Constants.EXTRACT_IMAGES_KEY;
import static pdf.pdftool.util.Constants.EXTRACT_TEXT_KEY;
import static pdf.pdftool.util.Constants.HISTORY_KEY;
import static pdf.pdftool.util.Constants.IMAGE_TO_PDF_KEY;
import static pdf.pdftool.util.Constants.INVERT_PDF_KEY;
import static pdf.pdftool.util.Constants.MERGE_PDF_KEY;
import static pdf.pdftool.util.Constants.PDF_TO_IMAGES;
import static pdf.pdftool.util.Constants.PDF_TO_IMAGES_KEY;
import static pdf.pdftool.util.Constants.QR_BARCODE_KEY;
import static pdf.pdftool.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static pdf.pdftool.util.Constants.REMOVE_PAGES;
import static pdf.pdftool.util.Constants.REMOVE_PAGES_KEY;
import static pdf.pdftool.util.Constants.REMOVE_PASSWORD_KEY;
import static pdf.pdftool.util.Constants.REMOVE_PWd;
import static pdf.pdftool.util.Constants.REORDER_PAGES;
import static pdf.pdftool.util.Constants.REORDER_PAGES_KEY;
import static pdf.pdftool.util.Constants.ROTATE_PAGES;
import static pdf.pdftool.util.Constants.ROTATE_PAGES_KEY;
import static pdf.pdftool.util.Constants.SPLIT_PDF_KEY;
import static pdf.pdftool.util.Constants.TEXT_TO_PDF_KEY;
import static pdf.pdftool.util.Constants.VIEW_FILES_KEY;
import static pdf.pdftool.util.Constants.ZIP_TO_PDF_KEY;
...
public class FragmentFavourites extends Fragment
    ...
    OurCardView pref_zip_to_pdf;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.favourites_file_fragment, container, false);
    ...
    private void initializeValues() {
        ...
        mFragmentPositionMap = CommonCodeTestingUtils.getInstance().fillNavigationItemsMap(false);
    ...
    public void onAddFavouriteButtonClicked() {
        startActivity(new Intent(this.getContext(), ActivityFavourites.class));
    }

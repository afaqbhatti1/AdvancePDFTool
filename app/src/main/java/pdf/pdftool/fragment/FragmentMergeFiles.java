...
import pdf.pdftool.adapter.AdapterMergeSelectedFiles;
import pdf.pdftool.database.HelperDatabase;
import pdf.pdftool.interfaces.BottomSheetPopulate;
import pdf.pdftool.interfaces.MergeFilesListener;
...
import pdf.pdftool.util.MergePdf;
import pdf.pdftool.util.MergePdfEnhancementOptionsUtils;
import pdf.pdftool.util.MorphButtonUtility;
import pdf.pdftool.util.RealPathUtil;
import pdf.pdftool.util.StringUtils;
import pdf.pdftool.util.ViewFilesDividerItemDecoration;
...
public class FragmentMergeFiles extends Fragment implements AdapterMergeFiles.OnClickListener, MergeFilesListener,
        AdapterMergeSelectedFiles.OnFileItemClickListener, OnItemClickListener,
    ...
    private AdapterMergeSelectedFiles mMergeSelectedFilesAdapter;
    private MaterialDialog mMaterialDialog;
    private String mHomePath;
    private ArrayList<OptionsEntityEnhancement> mEnhancementOptionsEntityArrayList;
    private AdapterEnhancementOptions mEnhancementOptionsAdapter;
    ...
    public FragmentMergeFiles() {
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.merge_files_fragment_, container, false);
        ButterKnife.bind(this, root);
        showEnhancementOptions();
        mSheetBehavior = BottomSheetBehavior.from(layoutBottomSheet);
        mFilePaths = new ArrayList<>();
        mMergeSelectedFilesAdapter = new AdapterMergeSelectedFiles(mActivity, mFilePaths, this);
    ...
    private void showEnhancementOptions() {
        ...
        mEnhancementOptionsAdapter = new AdapterEnhancementOptions(this, mEnhancementOptionsEntityArrayList);
    ...
    public void resetValues(boolean isPDFMerged, String path) {
        ...
        if (isPDFMerged) {
            ...
            new HelperDatabase(mActivity).insertRecord(path,

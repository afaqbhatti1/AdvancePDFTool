...
import pdf.pdftool.util.InvertPdf;
...
public class FragmentInvertPdf extends Fragment implements AdapterMergeFiles.OnClickListener,
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.invert_pdf_fragment, container, false);
    ...
    public void onPDFCreated(boolean isNewPdfCreated, String path) {
        ...
        new HelperDatabase(mActivity).insertRecord(path, mActivity.getString(R.string.snackbar_invert_successfull));

...
import pdf.pdftool.adapter.AdapterHistory;
import pdf.pdftool.database.AppDatabase;
import pdf.pdftool.database.HistoryDatabase;
...
public class FragmentHistory extends Fragment implements AdapterHistory.OnClickListener {
    ...
    private List<HistoryDatabase> mHistoryList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        new HistoryLoad(mActivity).execute(new String[0]);
        return root;
    }
    ...
    private void openFilterDialog() {
        ...
        builder.setPositiveButton(R.string.ok, (dialogInterface, i) -> {
            ...
            new HistoryLoad(mActivity).execute(selectedOptions.toArray(new String[0]));
        });
    ...
    private void deleteHistory() {
        ...
        builder.onPositive((dialog2, which) -> new HistoryDelete().execute())
                .show();
    }
    ...
    private class HistoryLoad extends AsyncTask<String[], Void, Void> {
        private final Context mContext;

        HistoryLoad(Context mContext) {
        ...
        protected void onPostExecute(Void aVoid) {
            if (mHistoryList != null && !mHistoryList.isEmpty()) {
                ...
                mHistoryAdapter = new AdapterHistory(mActivity, mHistoryList, FragmentHistory.this);
    ...
    @SuppressLint("StaticFieldLeak")
    private class HistoryDelete extends AsyncTask<Void, Void, Void> {

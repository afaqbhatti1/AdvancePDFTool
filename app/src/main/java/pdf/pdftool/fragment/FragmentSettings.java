...
import static pdf.pdftool.util.Constants.MODIFY_STORAGE_LOCATION_CODE;
import static pdf.pdftool.util.Constants.STORAGE_LOCATION;
import static pdf.pdftool.util.Constants.appName;
import static pdf.pdftool.util.SettingsOptions.getEnhancementOptions;

public class FragmentSettings extends Fragment implements OnItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.settings_fragment_, container, false);
    ...
    private void showSettingsOptions() {
        ...
        ArrayList<OptionsEntityEnhancement> mEnhancementOptionsEntityArrayList = getEnhancementOptions(mActivity);
    ...
    private void changeMasterPassword() {
        ...
        MaterialDialog materialDialog =
                builder.customView(R.layout.dialog_change_pwd, true)
    ...
    private void editFontSize() {
        ...
        MaterialDialog dialog = builder.customView(R.layout.font_size_dialog_file, true)
                .onPositive((dialog1, which) -> {
    ...
    private void changeFontFamily() {
        ...
        MaterialDialog materialDialog = builder.customView(R.layout.dialog_font_folder, true)
    ...
    private void setTheme() {
        MaterialDialog.Builder builder = DialogUtils.getInstance().createCustomDialogWithoutContent(mActivity,
                R.string.theme_edit);
        MaterialDialog materialDialog = builder.customView(R.layout.dialog_default_theme, true)
                .onPositive(((dialog, which) -> {
                    View view = dialog.getCustomView();

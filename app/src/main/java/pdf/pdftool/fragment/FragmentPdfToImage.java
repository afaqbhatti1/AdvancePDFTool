...
import pdf.pdftool.activity.PicturesPreviewActivity;
...
import pdf.pdftool.interfaces.ExtractImagesListener;
...
public class FragmentPdfToImage extends Fragment implements BottomSheetPopulate, AdapterMergeFiles.OnClickListener,
        ExtractImagesListener, AdapterExtractImages.OnFileItemClickedListener, OnBackPressedInterface {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.pdf_to_image_fragment, container, false);
    ...
    void onViewImagesClicked() {
        mActivity.startActivity(PicturesPreviewActivity.getStartIntent(mActivity, mOutputFilePaths));
    }
    ...
    public void updateView(int imageCount, ArrayList<String> outputFilePaths) {
        ...
        CommonCodeTestingUtils.getInstance().updateView(mActivity, imageCount, outputFilePaths,

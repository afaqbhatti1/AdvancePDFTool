...
import pdf.pdftool.activity.PdfPagesRearrange;
...
import pdf.pdftool.interfaces.OnPDFCompressedInterface;
import pdf.pdftool.interfaces.OnPdfReorderedInterface;
...
import static pdf.pdftool.util.FileUtils.getFormattedSize;

public class FragmentRemovePages extends Fragment implements AdapterMergeFiles.OnClickListener,
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View rootview = inflater.inflate(R.layout.remove_pages_fragment, container, false);
    ...
    public void onPdfReorderCompleted(List<Bitmap> bitmaps) {
        mMaterialDialog.dismiss();
        PdfPagesRearrange.mImages = new ArrayList<>(bitmaps);
        bitmaps.clear(); //releasing memory
        startActivityForResult(PdfPagesRearrange.getStartIntent(mActivity),

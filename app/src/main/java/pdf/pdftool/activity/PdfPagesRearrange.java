...
import pdf.pdftool.adapter.AdapterRearrangePdf;
...
import static pdf.pdftool.util.Constants.SAME_FILE;

public class PdfPagesRearrange extends AppCompatActivity implements AdapterRearrangePdf.OnClickListener {
    ...
    public static Intent getStartIntent(Context context) {
        return new Intent(context, PdfPagesRearrange.class);
    }
}

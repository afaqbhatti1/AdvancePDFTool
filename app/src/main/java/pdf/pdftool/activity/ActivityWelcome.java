...
public class ActivityWelcome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_welcome_frontpage);
        ButterKnife.bind(this);

        // layouts of all welcome sliders
        // add few more layouts if you want
        mLayouts = new int[]{
                R.layout.create_pdf_fragment,
                R.layout.fragment_view_file_step,
                R.layout.merge_pdf_fragment,
                R.layout.fragment_text_to_pdf_step,
                R.layout.qrcode_to_pdf_fragment,
                R.layout.remove_pages_fragment_,
                R.layout.fragment_reorder_pages_step,
                R.layout.extract_images_fragment};

        // adding bottom dots
        addBottomDots(0);

        PagerMyViewAdapter adapter = new PagerMyViewAdapter();
    ...
    class PagerMyViewAdapter extends PagerAdapter {

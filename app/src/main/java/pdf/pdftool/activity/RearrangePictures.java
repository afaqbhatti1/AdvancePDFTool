...
import pdf.pdftool.adapter.AdapterRearrangeImages;
...
import static pdf.pdftool.util.Constants.CHOICE_REMOVE_IMAGE;
import static pdf.pdftool.util.Constants.PREVIEW_IMAGES;

public class RearrangePictures extends AppCompatActivity implements AdapterRearrangeImages.OnClickListener {

    @BindView(R.id.recyclerView)
    RecyclerView mRecyclerView;

    private ArrayList<String> mImages;
    private AdapterRearrangeImages mRearrangeImagesAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rearrange_picture);
    ...
    private void initRecyclerView(ArrayList<String> images) {
        ...
        mRearrangeImagesAdapter = new AdapterRearrangeImages(this, images, this);
    ...
    public static Intent getStartIntent(Context context, ArrayList<String>  uris) {
        Intent intent = new Intent(context, RearrangePictures.class);

...
import pdf.pdftool.adapter.AdapterBrushItem;
import pdf.pdftool.adapter.AdapterImageFilters;
import pdf.pdftool.interfaces.OnFilterItemClickedListener;
...
import pdf.pdftool.util.BrushToolUtils;
import pdf.pdftool.util.ImageFilterUtils;
import pdf.pdftool.util.StringUtils;
import pdf.pdftool.util.ThemeUtils;

import static pdf.pdftool.util.Constants.IMAGE_EDITOR_KEY;
import static pdf.pdftool.util.Constants.RESULT;

public class PictureEditor extends AppCompatActivity implements OnFilterItemClickedListener, OnItemClickListener {

    private ArrayList<String> mFilterUris = new ArrayList<>();
    private final ArrayList<String> mImagePaths = new ArrayList<>();
    private ArrayList<ItemFilter> mFilterItems;
    private ArrayList<ToolsItemBrush> mBrushItems;
    ...
    private void initValues() {
        ...
        mBrushItems = BrushToolUtils.getInstance().getBrushItems();
    ...
    private void initRecyclerView() {
        ...
        AdapterBrushItem brushItemAdapter = new AdapterBrushItem(this,
                this, mBrushItems);
    ...
    public void onItemClick(int position) {
        ...
        if (position == mBrushItems.size() - 1) {
            final MaterialDialog colorPallete = new MaterialDialog.Builder(this)
                    ...
                    .customView(R.layout.colors_pallete_layout, true)
    ...
    public static Intent getStartIntent(Context context, ArrayList<String> uris) {
        Intent intent = new Intent(context, PictureEditor.class);

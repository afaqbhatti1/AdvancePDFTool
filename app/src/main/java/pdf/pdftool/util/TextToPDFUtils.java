...
public class TextToPDFUtils {
     ...
     */
    public void createPdfFromTextFile(OptionsTextToPDF mTextToPDFOptions, String fileExtension)
        ...
        new HelperDatabase(mContext).insertRecord(finalOutput, mContext.getString(R.string.created));
    }

    private void addContentToDocument(OptionsTextToPDF mTextToPDFOptions, String fileExtension,

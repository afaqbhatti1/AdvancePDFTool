...
import static pdf.pdftool.util.Constants.PATH_SEPERATOR;
...
public class FileUtils {
    ...
    public void printFile(final File file) {
        ...
        if (printManager != null) {
            ...
            new HelperDatabase(mContext).insertRecord(file.getAbsolutePath(), mContext.getString(R.string.printed));
        }
    }

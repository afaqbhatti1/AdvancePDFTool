...
public class WatermarkUtils {
    ...
    private WatermarkTool mWatermark;
    ...
    public void setWatermark(String path, final DataSetChanged dataSetChanged) {
        ...
        this.mWatermark = new WatermarkTool();
    ...
    private String createWatermark(String path) throws IOException, DocumentException {
        ...
        stamper.close();
        reader.close();
        new HelperDatabase(mContext).insertRecord(finalOutputFile, mContext.getString(R.string.watermarked));

...
public class BCallbackBottomSheet extends BottomSheetBehavior.BottomSheetCallback {

    private final ImageView mUpArrow;
    private final boolean mIsAdded;

    public BCallbackBottomSheet(ImageView mUpArrow, boolean mIsFragmentAdded) {

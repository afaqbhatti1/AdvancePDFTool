...
public class ColorUtilsTool {

    private static final double COLOR_DIFF_THRESHOLD = 30.0;

    private ColorUtilsTool() {
    }

    private static class SingletonHolder {
        static final ColorUtilsTool INSTANCE = new ColorUtilsTool();
    }

    public static ColorUtilsTool getInstance() {
        return ColorUtilsTool.SingletonHolder.INSTANCE;
    }

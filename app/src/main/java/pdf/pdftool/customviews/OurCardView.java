package pdf.pdftool.customviews;
...
public class OurCardView extends LinearLayout {
     ...
     */
    public OurCardView(@NonNull Context context) {
        super(context);
        init();
    }
     ...
     */
    public OurCardView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
     ...
     */
    public OurCardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {

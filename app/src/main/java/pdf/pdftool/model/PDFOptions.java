...
public class PDFOptions {
    ...
    PDFOptions(String mFileName, String mPageSize, boolean mPasswordProtected, String mPassword,
               int mBorderWidth, boolean mWatermarkAdded, WatermarkTool mWatermark, int pageColor) {
    ...
    public WatermarkTool getWatermark() {
        return this.mWatermark;
    }

    public void setWatermark(WatermarkTool mWatermark) {
        this.mWatermark = mWatermark;
    }

...
public class PictureToPDFOptions extends PDFOptions {
    ...
    public PictureToPDFOptions(String mFileName, String mPageSize, boolean mPasswordProtected,
                               String mPassword, String mQualityString, int mBorderWidth,
                               String masterPwd, ArrayList<String> mImagesUri,
                               boolean mWatermarkAdded, WatermarkTool mWatermark, int pageColor) {

...
public class OptionsTextToPDF extends PDFOptions {
    private final Uri mInFileUri;
    private final int mFontSize;
    private final Font.FontFamily mFontFamily;
    private final int mFontColor;

    public OptionsTextToPDF(String mFileName, String mPageSize, boolean mPasswordProtected,
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            final PreferencesTextToPdf preferences = new PreferencesTextToPdf(context);
        ...
        public OptionsTextToPDF build() {
            return new OptionsTextToPDF(mFileName, mPageSize, mPasswordProtected,

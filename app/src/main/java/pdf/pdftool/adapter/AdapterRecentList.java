...
public class AdapterRecentList extends RecyclerView.Adapter<AdapterRecentList.RecentItemViewHolder>  {

    private List<String> mKeys;
    private List<Map<String, String>> mValues;
    private final View.OnClickListener mOnClickListener;

    public AdapterRecentList(View.OnClickListener listener) {
    ...
    @NonNull @Override public RecentItemViewHolder onCreateViewHolder(
        ...
        return new AdapterRecentList.RecentItemViewHolder(mView);
    }

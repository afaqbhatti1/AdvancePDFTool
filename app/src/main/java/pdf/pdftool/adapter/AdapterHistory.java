...
public class AdapterHistory extends RecyclerView.Adapter<AdapterHistory.ViewHistoryHolder> {
    ...
    private final List<HistoryDatabase> mHistoryList;
    private final OnClickListener mOnClickListener;
    private final HashMap<String, Integer> mIconsOperationList;

    public AdapterHistory(Activity mActivity, List<HistoryDatabase> mHistoryList, OnClickListener mOnClickListener) {

package pdf.pdftool.preferences;
...
/**
 * The {@link PreferencesTextToPdf} is responsible for managing the default enhancement values
 * for the Text-to-PDF enhancements.
 */
public class PreferencesTextToPdf {

    private final SharedPreferences mSharedPreferences;

    /**
     * Creates a new {@link PreferencesTextToPdf}.
     *
     * @param context The {@link Context} used for the {@link SharedPreferences}.
     */
    public PreferencesTextToPdf(@NonNull final Context context) {
